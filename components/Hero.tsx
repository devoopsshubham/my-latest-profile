    ...
    <section className="min-h-screen flex items-center justify-center text-center -mt-16">
      <div className="max-w-4xl mx-auto px-4">
        <div className="relative">
            ...
            <h1 className="relative text-5xl md:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-gray-400 mb-6">
